    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              ONAHO 致力于为消费者提供专业、客观的产品测评和信息，帮助您做出明智的购买决策。
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products" className="text-gray-400 hover:text-white">产品</Link>
              </li>
              <li>
                <Link href="/reviews" className="text-gray-400 hover:text-white">测评</Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} ONAHO. 保留所有权利。</p>
        </div>
      </div>
    </footer>
  );
